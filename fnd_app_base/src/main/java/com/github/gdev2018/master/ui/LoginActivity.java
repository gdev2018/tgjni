...
import com.github.gdev2018.master.SRPHelper;
...
import com.github.gdev2018.master.ui.Components.HintEditText;
import com.github.gdev2018.master.ui.Components.LayoutHelper;
import com.github.gdev2018.master.ui.Components.SlideView;
...
public class LoginActivity extends BaseFragment {
    ...
    private Bundle loadCurrentState() {
        try {
            ...
            SharedPreferences preferences = BaseApplication.mApplicationContext.getSharedPreferences("logininfo2", Context.MODE_PRIVATE);
...
///*                        SharedPreferences preferences = MessagesController.getGlobalMainSettings();*/
            ...
            if (countryState == 1) {
                ...
                return;
            } else if (countryState == 2 && !BaseBuildVars.DEBUG_VERSION) {
            ...
            req.api_hash = BaseBuildVars.APP_HASH;
            req.api_id = BaseBuildVars.APP_ID;
        ...
        public void onNextPressed() {
            ...
            Utilities.globalQueue.postRunnable(() -> {
                ...
                if (current_algo instanceof TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) {
                    byte[] passwordBytes = Utilities.getStringBytes(oldPassword);
