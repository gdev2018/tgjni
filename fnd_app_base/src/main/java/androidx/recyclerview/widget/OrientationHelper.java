 ...
 * decorations.
 *
 * @see #createHorizontalHelper(androidx.recyclerview.widget.RecyclerView.LayoutManager)
 * @see #createVerticalHelper(androidx.recyclerview.widget.RecyclerView.LayoutManager)
 */
public abstract class OrientationHelper {
    ...
    /**
     * Returns the {@link androidx.recyclerview.widget.RecyclerView.LayoutManager LayoutManager} that
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager#onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler,
     * androidx.recyclerview.widget.RecyclerView.State)} method.
     *
     ...
     * its position
     *
     * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#getTransformedBoundingBox(View, boolean, Rect)
     */
     ...
     * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#getWidthMode()
     * @see androidx.recyclerview.widget.RecyclerView.LayoutManager#getHeightMode()
     */
    ...
    public static OrientationHelper createOrientationHelper(
            androidx.recyclerview.widget.RecyclerView.LayoutManager layoutManager, @androidx.recyclerview.widget.RecyclerView.Orientation int orientation) {
        switch (orientation) {
            case HORIZONTAL:
     ...
     * @return A new OrientationHelper
     */
    public static OrientationHelper createVerticalHelper(androidx.recyclerview.widget.RecyclerView.LayoutManager layoutManager) {
        return new OrientationHelper(layoutManager) {
            @Override
            public int getEndAfterPadding() {
            ...
            @Override
            public int getDecoratedStart(View view) {
                final androidx.recyclerview.widget.RecyclerView.LayoutParams params = (RecyclerView.LayoutParams)
                        view.getLayoutParams();
