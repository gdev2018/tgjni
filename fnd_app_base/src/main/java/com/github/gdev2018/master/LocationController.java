...
public class LocationController implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void startService() {
        try {
            /*if (Build.VERSION.SDK_INT >= 26) {
                BaseApplication.mApplicationContext.startForegroundService(new Intent(BaseApplication.mApplicationContext, LocationSharingService.class));
            } else {*/
                BaseApplication.mApplicationContext.startService(new Intent(BaseApplication.mApplicationContext, LocationSharingService.class));
            //}
        } catch (Throwable e) {
            FileLog.e(e);
        }
    ...
    private void stopService() {
        BaseApplication.mApplicationContext.stopService(new Intent(BaseApplication.mApplicationContext, LocationSharingService.class));
    }
