...
/**
 * Configuration object for {@link ListAdapter}, {@link androidx_tgjni.recyclerview.widget.AsyncListDiffer}, and similar
 * background-thread list diffing adapter logic.
 * <p>
 * At minimum, defines item diffing behavior with a {@link androidx_tgjni.recyclerview.widget.DiffUtil.ItemCallback}, used to compute
...
public final class AsyncDifferConfig<T> {
    ...
    @NonNull
    private final androidx_tgjni.recyclerview.widget.DiffUtil.ItemCallback<T> mDiffCallback;
    ...
    @SuppressWarnings("WeakerAccess")
    @NonNull
    public androidx_tgjni.recyclerview.widget.DiffUtil.ItemCallback<T> getDiffCallback() {
