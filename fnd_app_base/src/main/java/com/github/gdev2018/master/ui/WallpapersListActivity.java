...
import com.github.gdev2018.master.ui.Cells.WallpaperCell;
...
import com.github.gdev2018.master.ui.Components.WallpaperUpdater;
...
public class WallpapersListActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class ColorWallpaper {
        ...
        public String getUrl() {
            ...
            if (pattern != null) {
                String link = "https://" + MessagesController.getInstance(BaseUserConfig.selectedAccount).linkPrefix + "/bg/" + pattern.slug + "?intensity=" + (int) (intensity * 100) + "&bg_color=" + color1;
                if (motion) {
                    link += "&mode=motion";
                }
                return link;
            } else {
                return "https://" + MessagesController.getInstance(BaseUserConfig.selectedAccount).linkPrefix + "/bg/" + color1;
            }
        }
    }
