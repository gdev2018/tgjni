...
class AdapterHelper implements androidx.recyclerview.widget.OpReorderer.Callback {
    ...
    AdapterHelper(Callback callback, boolean disableRecycler) {
        ...
        mOpReorderer = new androidx.recyclerview.widget.OpReorderer(this);
    }
    ...
    private void applyRemove(UpdateOp op) {
        ...
        for (int position = op.positionStart; position < tmpEnd; position++) {
            ...
            androidx.recyclerview.widget.RecyclerView.ViewHolder vh = mCallback.findViewHolder(position);
