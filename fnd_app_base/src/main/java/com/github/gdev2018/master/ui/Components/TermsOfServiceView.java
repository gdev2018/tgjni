...
public class TermsOfServiceView extends FrameLayout {
    ...
    public TermsOfServiceView(final Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            addView(view, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, AndroidUtilities.statusBarHeight));
        }
        ...
        scrollView.addView(textView, new LayoutParams(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT));
