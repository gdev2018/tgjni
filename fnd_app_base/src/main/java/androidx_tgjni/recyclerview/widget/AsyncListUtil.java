...
public class AsyncListUtil<T> {
    ...
    final androidx_tgjni.recyclerview.widget.ThreadUtil.MainThreadCallback<T> mMainThreadProxy;
    final androidx_tgjni.recyclerview.widget.ThreadUtil.BackgroundCallback<T> mBackgroundProxy;
    ...
    public AsyncListUtil(@NonNull Class<T> klass, int tileSize,
        ...
        androidx_tgjni.recyclerview.widget.ThreadUtil<T> threadUtil = new androidx_tgjni.recyclerview.widget.MessageThreadUtil<T>();
    ...
    private final androidx_tgjni.recyclerview.widget.ThreadUtil.MainThreadCallback<T>
            mMainThreadCallback = new androidx_tgjni.recyclerview.widget.ThreadUtil.MainThreadCallback<T>() {
        @Override
    ...
    private final androidx_tgjni.recyclerview.widget.ThreadUtil.BackgroundCallback<T>
            mBackgroundCallback = new androidx_tgjni.recyclerview.widget.ThreadUtil.BackgroundCallback<T>() {
