...
import com.github.gdev2018.master.voip.VideoCapturerDevice;
...
import com.github.gdev2018.master.ui.Components.CrossOutDrawable;
import com.github.gdev2018.master.ui.Components.CubicBezierInterpolator;
import com.github.gdev2018.master.ui.Components.GroupCallFullscreenAdapter;
...
//    }*/
        ...
        if (attached) {
            ...
            if (!ChatObject.Call.videoIsActive(participant.participant, participant.presentation, call) || !call.canStreamVideo && participant != call.videoNotAvailableParticipant) {
                ...
                if (peerId > 0) {
                    ...
                    TLRPC.Chat currentChat = AccountInstance.getInstance(BaseUserConfig.selectedAccount).getMessagesController().getChat(-peerId);
    ...
    public String getName() {
        int peerId = MessageObject.getPeerId(participant.participant.peer);
        if (peerId > 0) {
            TLRPC.User currentUser = AccountInstance.getInstance(BaseUserConfig.selectedAccount).getMessagesController().getUser(peerId);
