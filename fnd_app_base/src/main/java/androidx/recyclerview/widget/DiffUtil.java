 ...
 * <p>
 * It can be used to calculate updates for a RecyclerView Adapter. See {@link androidx.recyclerview.widget.ListAdapter} and
...
public class DiffUtil {
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.Adapter} via {@link #dispatchUpdatesTo(androidx.recyclerview.widget.RecyclerView.Adapter)}.
     */
    public static class DiffResult {
         ...
         */
        public void dispatchUpdatesTo(@NonNull final androidx.recyclerview.widget.RecyclerView.Adapter adapter) {
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback updateCallback) {
            final androidx.recyclerview.widget.BatchingListUpdateCallback batchingCallback;
            if (updateCallback instanceof androidx.recyclerview.widget.BatchingListUpdateCallback) {
                batchingCallback = (androidx.recyclerview.widget.BatchingListUpdateCallback) updateCallback;
            } else {
