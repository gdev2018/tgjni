...
/**
 * Helper for computing the difference between two lists via {@link androidx_tgjni.recyclerview.widget.DiffUtil} on a background
 * thread.
 * <p>
 * It can be connected to a
 * {@link androidx_tgjni.recyclerview.widget.RecyclerView.Adapter RecyclerView.Adapter}, and will signal the
 ...
 * data simply for an adapter. It computes differences in list contents via {@link androidx_tgjni.recyclerview.widget.DiffUtil} on a
 ...
 *
 * @see androidx_tgjni.recyclerview.widget.DiffUtil
...
public class AsyncListDiffer<T> {
     ...
     *
     * @see androidx_tgjni.recyclerview.widget.DiffUtil.DiffResult#dispatchUpdatesTo(androidx_tgjni.recyclerview.widget.RecyclerView.Adapter)
     */
    public AsyncListDiffer(@NonNull androidx_tgjni.recyclerview.widget.RecyclerView.Adapter adapter,
            @NonNull androidx_tgjni.recyclerview.widget.DiffUtil.ItemCallback<T> diffCallback) {
     ...
     *
     * @see androidx_tgjni.recyclerview.widget.DiffUtil.DiffResult#dispatchUpdatesTo(RecyclerView.Adapter)
     */
    ...
    public void submitList(@Nullable final List<T> newList,
        ...
        mConfig.getBackgroundThreadExecutor().execute(new Runnable() {
            @Override
            public void run() {
                final androidx_tgjni.recyclerview.widget.DiffUtil.DiffResult result = androidx_tgjni.recyclerview.widget.DiffUtil.calculateDiff(new androidx_tgjni.recyclerview.widget.DiffUtil.Callback() {
                    @Override
