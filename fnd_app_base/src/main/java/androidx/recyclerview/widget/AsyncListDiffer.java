...
/**
 * Helper for computing the difference between two lists via {@link androidx.recyclerview.widget.DiffUtil} on a background
 * thread.
 * <p>
 * It can be connected to a
 * {@link androidx.recyclerview.widget.RecyclerView.Adapter RecyclerView.Adapter}, and will signal the
 ...
 * data simply for an adapter. It computes differences in list contents via {@link androidx.recyclerview.widget.DiffUtil} on a
...
public class AsyncListDiffer<T> {
     ...
     *
     * @see androidx.recyclerview.widget.DiffUtil.DiffResult#dispatchUpdatesTo(androidx.recyclerview.widget.RecyclerView.Adapter)
     */
    public AsyncListDiffer(@NonNull androidx.recyclerview.widget.RecyclerView.Adapter adapter,
            @NonNull androidx.recyclerview.widget.DiffUtil.ItemCallback<T> diffCallback) {
     ...
     *
     * @see androidx.recyclerview.widget.DiffUtil.DiffResult#dispatchUpdatesTo(RecyclerView.Adapter)
     */
    ...
    public void submitList(@Nullable final List<T> newList,
        ...
        mConfig.getBackgroundThreadExecutor().execute(new Runnable() {
            @Override
            public void run() {
                final androidx.recyclerview.widget.DiffUtil.DiffResult result = androidx.recyclerview.widget.DiffUtil.calculateDiff(new androidx.recyclerview.widget.DiffUtil.Callback() {
                    @Override
