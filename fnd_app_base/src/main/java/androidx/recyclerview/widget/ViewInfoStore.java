...
class ViewInfoStore {
     ...
     */
    @VisibleForTesting
    final ArrayMap<androidx.recyclerview.widget.RecyclerView.ViewHolder, InfoRecord> mLayoutHolderMap = new ArrayMap<>();

    @VisibleForTesting
    final LongSparseArray<androidx.recyclerview.widget.RecyclerView.ViewHolder> mOldChangedHolders = new LongSparseArray<>();
     ...
     */
    void addToPreLayout(androidx.recyclerview.widget.RecyclerView.ViewHolder holder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo info) {
    ...
    boolean isDisappearing(androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
     ...
     */
    @Nullable
    androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo popFromPreLayout(androidx.recyclerview.widget.RecyclerView.ViewHolder vh) {
     ...
     */
    @Nullable
    androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo popFromPostLayout(androidx.recyclerview.widget.RecyclerView.ViewHolder vh) {
        return popFromLayoutStep(vh, FLAG_POST);
    }

    private androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo popFromLayoutStep(androidx.recyclerview.widget.RecyclerView.ViewHolder vh, int flag) {
        ...
        if (record != null && (record.flags & flag) != 0) {
            record.flags &= ~flag;
            final androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo info;
            if (flag == FLAG_PRE) {
                info = record.preInfo;
     ...
     */
    void addToOldChangeHolders(long key, androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
     ...
     * @param info The information to save
     */
    void addToAppearedInPreLayoutHolders(androidx.recyclerview.widget.RecyclerView.ViewHolder holder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo info) {
        InfoRecord record = mLayoutHolderMap.get(holder);
        if (record == null) {
            record = InfoRecord.obtain();
            mLayoutHolderMap.put(holder, record);
     ...
     */
    androidx.recyclerview.widget.RecyclerView.ViewHolder getFromOldChangeHolders(long key) {
     ...
     * @param info The information to save
     */
    void addToPostLayout(androidx.recyclerview.widget.RecyclerView.ViewHolder holder, androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo info) {
        InfoRecord record = mLayoutHolderMap.get(holder);
        if (record == null) {
            record = InfoRecord.obtain();
            mLayoutHolderMap.put(holder, record);
     ...
     */
    void addToDisappearedInLayout(androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
        InfoRecord record = mLayoutHolderMap.get(holder);
        if (record == null) {
            record = InfoRecord.obtain();
            mLayoutHolderMap.put(holder, record);
     ...
     */
    void removeFromDisappearedInLayout(androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
        InfoRecord record = mLayoutHolderMap.get(holder);
        if (record == null) {
            return;
        }
    ...
    void process(ProcessCallback callback) {
        for (int index = mLayoutHolderMap.size() - 1; index >= 0; index--) {
            final androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder = mLayoutHolderMap.keyAt(index);
     ...
     */
    void removeViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
    ...
    interface ProcessCallback {
        void processDisappeared(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder, @NonNull androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo preInfo,
                                @Nullable androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo postInfo);
        void processAppeared(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder, @Nullable androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo preInfo,
                             androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo postInfo);
        void processPersistent(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder, @NonNull androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo preInfo,
                               @NonNull androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo postInfo);
        void unused(androidx.recyclerview.widget.RecyclerView.ViewHolder holder);
    }
