...
public class CameraSession {
    ...
    public CameraSession(CameraInfo info, Size preview, Size picture, int format) {
        ...
        SharedPreferences sharedPreferences = BaseApplication.mApplicationContext.getSharedPreferences("camera", Activity.MODE_PRIVATE);
        ...
        orientationEventListener = new OrientationEventListener(BaseApplication.mApplicationContext) {
            ...
            public void onOrientationChanged(int orientation) {
                ...
                WindowManager mgr = (WindowManager) BaseApplication.mApplicationContext.getSystemService(Context.WINDOW_SERVICE);
