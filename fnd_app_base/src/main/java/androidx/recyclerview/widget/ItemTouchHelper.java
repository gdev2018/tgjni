 ...
 * {@link Callback#onMove(androidx.recyclerview.widget.RecyclerView, ViewHolder, ViewHolder)} and / or
 ...
 * customize these behaviors by overriding {@link Callback#onChildDraw(Canvas, androidx.recyclerview.widget.RecyclerView,
 * ViewHolder, float, float, int, boolean)}
 * or {@link Callback#onChildDrawOver(Canvas, androidx.recyclerview.widget.RecyclerView, ViewHolder, float, float, int,
 * boolean)}.
 * <p/>
...
public class ItemTouchHelper extends androidx.recyclerview.widget.RecyclerView.ItemDecoration
        implements androidx.recyclerview.widget.RecyclerView.OnChildAttachStateChangeListener {
     ...
     * {@link Callback#getAbsoluteMovementFlags(androidx.recyclerview.widget.RecyclerView, ViewHolder)} for the current
     * action state.
     */
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    int mSelectedFlags;
    ...
    private final OnItemTouchListener mOnItemTouchListener = new OnItemTouchListener() {
        @Override
        public boolean onInterceptTouchEvent(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView,
        ...
        @Override
        public void onTouchEvent(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView, @NonNull MotionEvent event) {
            mGestureDetector.onTouchEvent(event);
            if (DEBUG) {
                Log.d(TAG,
     ...
     * {@link #attachToRecyclerView(androidx.recyclerview.widget.RecyclerView)}. Upon attaching, it will add an item decoration,
     ...
     *                     RecyclerView.
     */
    public void attachToRecyclerView(@Nullable androidx.recyclerview.widget.RecyclerView recyclerView) {
        ...
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                if (mRecyclerView != null && mRecyclerView.isAttachedToWindow()
                        && !anim.mOverridden
                        && anim.mViewHolder.getAdapterPosition() != androidx.recyclerview.widget.RecyclerView.NO_POSITION) {
                    final androidx.recyclerview.widget.RecyclerView.ItemAnimator animator = mRecyclerView.getItemAnimator();
    ...
    boolean scrollIfNecessary() {
        ...
        androidx.recyclerview.widget.RecyclerView.LayoutManager lm = mRecyclerView.getLayoutManager();
        if (mTmpRect == null) {
            mTmpRect = new Rect();
        }
        int scrollX = 0;
    ...
    private List<ViewHolder> findSwapTargets(ViewHolder viewHolder) {
        ...
        final androidx.recyclerview.widget.RecyclerView.LayoutManager lm = mRecyclerView.getLayoutManager();
    ...
    void checkSelectForSwipe(int action, MotionEvent motionEvent, int pointerIndex) {
        ...
        if (mRecyclerView.getScrollState() == androidx.recyclerview.widget.RecyclerView.SCROLL_STATE_DRAGGING) {
            return;
        }
    ...
    private void addChildDrawingOrderCallback() {
        ...
        if (mChildDrawingOrderCallback == null) {
            mChildDrawingOrderCallback = new androidx.recyclerview.widget.RecyclerView.ChildDrawingOrderCallback() {
                @Override
     ...
     * {@link #getMovementFlags(androidx.recyclerview.widget.RecyclerView, ViewHolder)} and return appropriate set
     ...
     * {@link Callback#onMove(androidx.recyclerview.widget.RecyclerView, ViewHolder, ViewHolder)
     ...
     * in your adapter and also call {@link androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemMoved(int, int)}.
     * To control where a View can be dropped, you can override
     * {@link #canDropOver(androidx.recyclerview.widget.RecyclerView, ViewHolder, ViewHolder)}. When a
    ...
    public abstract static class Callback {
        ...
        /**
         * Returns the {@link androidx.recyclerview.widget.ItemTouchUIUtil} that is used by the {@link Callback} class for
         * visual
         ...
         * </pre>
         *
         * @return The {@link androidx.recyclerview.widget.ItemTouchUIUtil} instance that is used by the {@link Callback}
         */
        @SuppressWarnings("WeakerAccess")
        @NonNull
         ...
         */
        public abstract int getMovementFlags(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView,
        ...
        final int getAbsoluteMovementFlags(androidx.recyclerview.widget.RecyclerView recyclerView,
                                           ViewHolder viewHolder) {
            final int flags = getMovementFlags(recyclerView, viewHolder);
            return convertToAbsoluteDirection(flags, ViewCompat.getLayoutDirection(recyclerView));
        }

        boolean hasDragFlag(androidx.recyclerview.widget.RecyclerView recyclerView, ViewHolder viewHolder) {
            final int flags = getAbsoluteMovementFlags(recyclerView, viewHolder);
            return (flags & ACTION_MODE_DRAG_MASK) != 0;
        }

        boolean hasSwipeFlag(androidx.recyclerview.widget.RecyclerView recyclerView,
                             ViewHolder viewHolder) {
            final int flags = getAbsoluteMovementFlags(recyclerView, viewHolder);
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public boolean canDropOver(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView, @NonNull ViewHolder current,
         ...
         * {@code target}.
         * @see #onMoved(androidx.recyclerview.widget.RecyclerView, ViewHolder, int, ViewHolder, int, int, int)
         */
        public abstract boolean onMove(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView,
         ...
         *                    {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration}s.
         ...
         * {@link #getMovementFlags(androidx.recyclerview.widget.RecyclerView, ViewHolder)} method, this method
         ...
         * {@link #clearView(androidx.recyclerview.widget.RecyclerView, ViewHolder)}.
         *
         * @param viewHolder The ViewHolder which has been swiped by the user.
         * @param direction  The direction to which the ViewHolder is swiped. It is one of
         *                   {@link #UP}, {@link #DOWN},
         *                   {@link #LEFT} or {@link #RIGHT}. If your
         *                   {@link #getMovementFlags(androidx.recyclerview.widget.RecyclerView, ViewHolder)}
         *                   method
         ...
         * @see #clearView(androidx.recyclerview.widget.RecyclerView, ViewHolder)
         */
        ...
        /**
         * Called when {@link #onMove(androidx.recyclerview.widget.RecyclerView, ViewHolder, ViewHolder)} returns true.
         * <p>
         ...
         *
         * Default implementation calls {@link androidx.recyclerview.widget.RecyclerView#scrollToPosition(int)} if the View's
         ...
         *                     {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration}s.
         */
        public void onMoved(@NonNull final androidx.recyclerview.widget.RecyclerView recyclerView,
                @NonNull final ViewHolder viewHolder, int fromPos, @NonNull final ViewHolder target,
                int toPos, int x, int y) {
            final androidx.recyclerview.widget.RecyclerView.LayoutManager layoutManager = recyclerView.getLayoutManager();
        ...
        void onDraw(Canvas c, androidx.recyclerview.widget.RecyclerView parent, ViewHolder selected,
        ...
        void onDrawOver(Canvas c, androidx.recyclerview.widget.RecyclerView parent, ViewHolder selected,
                        List<RecoverAnimation> recoverAnimationList,
                        int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
         ...
         * {@link #onChildDraw(Canvas, androidx.recyclerview.widget.RecyclerView, ViewHolder, float, float, int,
         * boolean)} or
         * {@link #onChildDrawOver(Canvas, androidx.recyclerview.widget.RecyclerView, ViewHolder, float, float, int, boolean)}.
         *
         * @param recyclerView The RecyclerView which is controlled by the ItemTouchHelper.
         * @param viewHolder   The View that was interacted by the user.
         */
        public void clearView(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView, @NonNull ViewHolder viewHolder) {
         ...
         * @see #onChildDrawOver(Canvas, androidx.recyclerview.widget.RecyclerView, ViewHolder, float, float, int,
         * boolean)
         */
        public void onChildDraw(@NonNull Canvas c, @NonNull androidx.recyclerview.widget.RecyclerView recyclerView,
                @NonNull ViewHolder viewHolder,
                float dX, float dY, int actionState, boolean isCurrentlyActive) {
            androidx.recyclerview.widget.ItemTouchUIUtilImpl.INSTANCE.onDraw(c, recyclerView, viewHolder.itemView, dX, dY,
                    actionState, isCurrentlyActive);
        }
         ...
         * boolean)
         */
        public void onChildDrawOver(@NonNull Canvas c, @NonNull androidx.recyclerview.widget.RecyclerView recyclerView,
                ViewHolder viewHolder,
                float dX, float dY, int actionState, boolean isCurrentlyActive) {
            androidx.recyclerview.widget.ItemTouchUIUtilImpl.INSTANCE.onDrawOver(c, recyclerView, viewHolder.itemView, dX, dY,
                    actionState, isCurrentlyActive);
        }
         ...
         * {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator#getMoveDuration()}, otherwise, it returns
         * {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator#getRemoveDuration()}. If RecyclerView does not have
         * any {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator} attached, this method returns
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public long getAnimationDuration(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView, int animationType,
                                         float animateDx, float animateDy) {
            final androidx.recyclerview.widget.RecyclerView.ItemAnimator itemAnimator = recyclerView.getItemAnimator();
         ...
         * be passed to {@link androidx.recyclerview.widget.RecyclerView#scrollBy(int, int)} method.
         */
        @SuppressWarnings("WeakerAccess")
        public int interpolateOutOfBoundsScroll(@NonNull androidx.recyclerview.widget.RecyclerView recyclerView,
    ...
    public abstract static class SimpleCallback extends Callback {
         ...
         * {@link #getSwipeDirs(androidx.recyclerview.widget.RecyclerView, ViewHolder)}
         * and / or {@link #getDragDirs(androidx.recyclerview.widget.RecyclerView, ViewHolder)}.
         *
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public int getSwipeDirs(@SuppressWarnings("unused") @NonNull androidx.recyclerview.widget.RecyclerView recyclerView,
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public int getDragDirs(@SuppressWarnings("unused") @NonNull androidx.recyclerview.widget.RecyclerView recyclerView,
