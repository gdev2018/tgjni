...
public class LinearSmoothScrollerEnd extends androidx_tgjni.recyclerview.widget.RecyclerView.SmoothScroller {
    ...
    @Override
    protected void onSeekTargetStep(int dx, int dy, androidx_tgjni.recyclerview.widget.RecyclerView.State state, Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    public int calculateDxToMakeVisible(View view) {
        final androidx_tgjni.recyclerview.widget.RecyclerView.LayoutManager layoutManager = getLayoutManager();
        if (layoutManager == null || !layoutManager.canScrollHorizontally()) {
            return 0;
        }
        final androidx_tgjni.recyclerview.widget.RecyclerView.LayoutParams params = (androidx_tgjni.recyclerview.widget.RecyclerView.LayoutParams) view.getLayoutParams();
