...
public class LinearSmoothScrollerEnd extends androidx.recyclerview.widget.RecyclerView.SmoothScroller {
    ...
    @Override
    protected void onSeekTargetStep(int dx, int dy, androidx.recyclerview.widget.RecyclerView.State state, Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    public int calculateDxToMakeVisible(View view) {
        final androidx.recyclerview.widget.RecyclerView.LayoutManager layoutManager = getLayoutManager();
        if (layoutManager == null || !layoutManager.canScrollHorizontally()) {
            return 0;
        }
        final androidx.recyclerview.widget.RecyclerView.LayoutParams params = (androidx.recyclerview.widget.RecyclerView.LayoutParams) view.getLayoutParams();
