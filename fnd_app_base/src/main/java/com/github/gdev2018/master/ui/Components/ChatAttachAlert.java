...
import com.github.gdev2018.master.camera.CameraView;
...
import com.github.gdev2018.master.ui.Cells.PhotoAttachCameraCell;
import com.github.gdev2018.master.ui.Cells.PhotoAttachPhotoCell;
...
//        };
        ...
        inputFilters[0] = new InputFilter.LengthFilter(MessagesController.getInstance(BaseUserConfig.selectedAccount).maxCaptionLength);
        ...
        try {
            ...
            if (bitmap != null) {
                ...
                if (lastBitmap != null) {
                    ...
                    File file = new File(BaseApplication.getFilesDirFixed(), "cthumb.jpg");
