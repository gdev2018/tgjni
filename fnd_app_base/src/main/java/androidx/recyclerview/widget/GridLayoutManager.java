...
/**
 * A {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} implementations that lays out items in a grid.
 * <p>
...
public class GridLayoutManager extends androidx.recyclerview.widget.LinearLayoutManager {
     ...
     */
    public GridLayoutManager(Context context, int spanCount,
                             @androidx.recyclerview.widget.RecyclerView.Orientation int orientation, boolean reverseLayout) {
    ...
    @Override
    public int getRowCountForAccessibility(androidx.recyclerview.widget.RecyclerView.Recycler recycler,
    ...
    @Override
    public int getColumnCountForAccessibility(androidx.recyclerview.widget.RecyclerView.Recycler recycler,
                                              androidx.recyclerview.widget.RecyclerView.State state) {
    ...
    @Override
    public void onInitializeAccessibilityNodeInfoForItem(androidx.recyclerview.widget.RecyclerView.Recycler recycler,
                                                         androidx.recyclerview.widget.RecyclerView.State state, View host, AccessibilityNodeInfoCompat info) {
    ...
    @Override
    public void onItemsAdded(androidx.recyclerview.widget.RecyclerView recyclerView, int positionStart, int itemCount) {
    ...
    @Override
    public void onItemsRemoved(androidx.recyclerview.widget.RecyclerView recyclerView, int positionStart, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }

    @Override
    public void onItemsUpdated(androidx.recyclerview.widget.RecyclerView recyclerView, int positionStart, int itemCount,
                               Object payload) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }
    ...
    @Override
    public void onItemsMoved(androidx.recyclerview.widget.RecyclerView recyclerView, int from, int to, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }
    ...
    @Override
    void onAnchorReady(androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state,
    ...
    @Override
    public int scrollHorizontallyBy(int dx, androidx.recyclerview.widget.RecyclerView.Recycler recycler,
                                    androidx.recyclerview.widget.RecyclerView.State state) {
        updateMeasurements();
        ensureViewSet();
    ...
    @Override
    public int scrollVerticallyBy(int dy, androidx.recyclerview.widget.RecyclerView.Recycler recycler,
                                  androidx.recyclerview.widget.RecyclerView.State state) {
        updateMeasurements();
        ensureViewSet();
    ...
    private void ensureAnchorIsInCorrectSpan(androidx.recyclerview.widget.RecyclerView.Recycler recycler,
                                             androidx.recyclerview.widget.RecyclerView.State state, AnchorInfo anchorInfo, int itemDirection) {
    ...
    @Override
    View findReferenceChild(androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state,
    ...
    private int getSpanGroupIndex(androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state,
                                  int viewPosition) {
        if (!state.isPreLayout()) {
    ...
    private int getSpanIndex(androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    protected int getSpanSize(androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    @Override
    void collectPrefetchPositionsForLayoutState(androidx.recyclerview.widget.RecyclerView.State state, LinearLayoutManager.LayoutState layoutState,
    ...
    @Override
    void layoutChunk(androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state,
    ...
    protected void assignSpans(androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state, int count,
    ...
    public View onFocusSearchFailed(View focused, int focusDirection,
                                    androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state) {
