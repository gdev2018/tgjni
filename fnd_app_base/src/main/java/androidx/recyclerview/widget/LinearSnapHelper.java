...
/**
 * Implementation of the {@link androidx.recyclerview.widget.SnapHelper} supporting snapping in either vertical or horizontal
 * orientation.
 * <p>
 * The implementation will snap the center of the target child view to the center of
 * the attached {@link androidx.recyclerview.widget.RecyclerView}. If you intend to change this behavior then override
 * {@link androidx.recyclerview.widget.SnapHelper#calculateDistanceToFinalSnap}.
 */
public class LinearSnapHelper extends SnapHelper {
    ...
    public int[] calculateDistanceToFinalSnap(
            @NonNull androidx.recyclerview.widget.RecyclerView.LayoutManager layoutManager, @NonNull View targetView) {
        int[] out = new int[2];
     ...
     * @param helper        The {@link androidx.recyclerview.widget.OrientationHelper} that is created from the LayoutManager.
     * @param velocityX     The velocity on the x axis.
     * @param velocityY     The velocity on the y axis.
     *
     * @return The diff between the target scroll position and the current position.
     */
    private int estimateNextPositionDiffForFling(androidx.recyclerview.widget.RecyclerView.LayoutManager layoutManager,
                                                 androidx.recyclerview.widget.OrientationHelper helper, int velocityX, int velocityY) {
     ...
     * @param layoutManager The {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} associated with the attached
     *                      {@link androidx.recyclerview.widget.RecyclerView}.
     * @param helper        The relevant {@link androidx.recyclerview.widget.OrientationHelper} for the attached
     *                      {@link androidx.recyclerview.widget.RecyclerView.LayoutManager}.
     *
     * @return A float value that is the average number of pixels needed to scroll by one view in
     * the relevant direction.
     */
    private float computeDistancePerChild(androidx.recyclerview.widget.RecyclerView.LayoutManager layoutManager,
                                          androidx.recyclerview.widget.OrientationHelper helper) {
