 ...
 * list
 * such that it can be bound to a {@link androidx_tgjni.recyclerview.widget.RecyclerView.Adapter
...
public class SortedList<T> {
    ...
    public static abstract class Callback<T2> implements Comparator<T2>, ListUpdateCallback {
         ...
         * {@link androidx_tgjni.recyclerview.widget.RecyclerView}, you can return the particular field that
    ...
    public static class BatchedCallback<T2> extends Callback<T2> {
        ...
        private final androidx_tgjni.recyclerview.widget.BatchingListUpdateCallback mBatchingListUpdateCallback;
        /**
