 ...
 */
class AdapterHelper implements androidx_tgjni.recyclerview.widget.OpReorderer.Callback {
    ...
    final androidx_tgjni.recyclerview.widget.OpReorderer mOpReorderer;
    ...
    AdapterHelper(Callback callback, boolean disableRecycler) {
        ...
        mOpReorderer = new androidx_tgjni.recyclerview.widget.OpReorderer(this);
    }
    ...
    private void applyRemove(UpdateOp op) {
        ...
        for (int position = op.positionStart; position < tmpEnd; position++) {
            ...
            androidx_tgjni.recyclerview.widget.RecyclerView.ViewHolder vh = mCallback.findViewHolder(position);
