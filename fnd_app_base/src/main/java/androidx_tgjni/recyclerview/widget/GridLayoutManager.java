...
/**
 * A {@link androidx_tgjni.recyclerview.widget.RecyclerView.LayoutManager} implementations that lays out items in a grid.
 * <p>
 * By default, each item occupies 1 span. You can change it by providing a custom
 * {@link SpanSizeLookup} instance via {@link #setSpanSizeLookup(SpanSizeLookup)}.
 */
public class GridLayoutManager extends androidx_tgjni.recyclerview.widget.LinearLayoutManager {
     ...
     */
    public GridLayoutManager(Context context, int spanCount,
                             @androidx_tgjni.recyclerview.widget.RecyclerView.Orientation int orientation, boolean reverseLayout) {
    ...
    @Override
    public int getRowCountForAccessibility(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler,
    ...
    @Override
    public int getColumnCountForAccessibility(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler,
                                              androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
    ...
    @Override
    public void onInitializeAccessibilityNodeInfoForItem(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler,
                                                         androidx_tgjni.recyclerview.widget.RecyclerView.State state, View host, AccessibilityNodeInfoCompat info) {
    ...
    @Override
    public void onLayoutChildren(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler, androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
    ...
    @Override
    public void onLayoutCompleted(androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
    ...
    @Override
    public void onItemsAdded(androidx_tgjni.recyclerview.widget.RecyclerView recyclerView, int positionStart, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }

    @Override
    public void onItemsChanged(androidx_tgjni.recyclerview.widget.RecyclerView recyclerView) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }

    @Override
    public void onItemsRemoved(androidx_tgjni.recyclerview.widget.RecyclerView recyclerView, int positionStart, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }

    @Override
    public void onItemsUpdated(androidx_tgjni.recyclerview.widget.RecyclerView recyclerView, int positionStart, int itemCount,
                               Object payload) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }
    ...
    @Override
    public void onItemsMoved(androidx_tgjni.recyclerview.widget.RecyclerView recyclerView, int from, int to, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }

    @Override
    public androidx_tgjni.recyclerview.widget.RecyclerView.LayoutParams generateDefaultLayoutParams() {
        if (mOrientation == HORIZONTAL) {
    ...
    @Override
    public androidx_tgjni.recyclerview.widget.RecyclerView.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
        return new LayoutParams(c, attrs);
    }

    @Override
    public androidx_tgjni.recyclerview.widget.RecyclerView.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
    ...
    @Override
    public boolean checkLayoutParams(androidx_tgjni.recyclerview.widget.RecyclerView.LayoutParams lp) {
    ...
    @Override
    void onAnchorReady(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler, androidx_tgjni.recyclerview.widget.RecyclerView.State state,
    ...
    @Override
    public int scrollHorizontallyBy(int dx, androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler,
            androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
        updateMeasurements();
        ensureViewSet();
    ...
    @Override
    public int scrollVerticallyBy(int dy, androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler,
            androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
        updateMeasurements();
        ensureViewSet();
    ...
    private void ensureAnchorIsInCorrectSpan(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler,
                                             androidx_tgjni.recyclerview.widget.RecyclerView.State state, AnchorInfo anchorInfo, int itemDirection) {
    ...
    @Override
    View findReferenceChild(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler, androidx_tgjni.recyclerview.widget.RecyclerView.State state,
        ...
        for (int i = start; i != end; i += diff) {
            ...
            if (position >= 0 && position < itemCount) {
                ...
                if (((androidx_tgjni.recyclerview.widget.RecyclerView.LayoutParams) view.getLayoutParams()).isItemRemoved()) {
    ...
    private int getSpanGroupIndex(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler, androidx_tgjni.recyclerview.widget.RecyclerView.State state,
                                  int viewPosition) {
        if (!state.isPreLayout()) {
    ...
    private int getSpanIndex(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler, androidx_tgjni.recyclerview.widget.RecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    protected int getSpanSize(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler, androidx_tgjni.recyclerview.widget.RecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    @Override
    void collectPrefetchPositionsForLayoutState(androidx_tgjni.recyclerview.widget.RecyclerView.State state, LinearLayoutManager.LayoutState layoutState,
    ...
    @Override
    void layoutChunk(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler, androidx_tgjni.recyclerview.widget.RecyclerView.State state,
    ...
    protected void measureChildWithDecorationsAndMargin(View child, int widthSpec, int heightSpec,
        ...
        androidx_tgjni.recyclerview.widget.RecyclerView.LayoutParams lp = (androidx_tgjni.recyclerview.widget.RecyclerView.LayoutParams) child.getLayoutParams();
    ...
    protected void assignSpans(androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler, androidx_tgjni.recyclerview.widget.RecyclerView.State state, int count,
    ...
    public View onFocusSearchFailed(View focused, int focusDirection,
                                    androidx_tgjni.recyclerview.widget.RecyclerView.Recycler recycler, androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
    ...
    @Override
    public int computeHorizontalScrollRange(androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
    ...
    @Override
    public int computeVerticalScrollRange(androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
        if (mUsingSpansToEstimateScrollBarDimensions) {
            return computeScrollRangeWithSpanInfo(state);
        } else {
    ...
    @Override
    public int computeHorizontalScrollOffset(androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
        if (mUsingSpansToEstimateScrollBarDimensions) {
    ...
    @Override
    public int computeVerticalScrollOffset(androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
        if (mUsingSpansToEstimateScrollBarDimensions) {
            return computeScrollOffsetWithSpanInfo(state);
        } else {
    ...
    private int computeScrollRangeWithSpanInfo(androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
    ...
    private int computeScrollOffsetWithSpanInfo(androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
        if (getChildCount() == 0 || state.getItemCount() == 0) {
            return 0;
        }
        ensureLayoutState();
     ...
     */
    public static class LayoutParams extends androidx_tgjni.recyclerview.widget.RecyclerView.LayoutParams {
