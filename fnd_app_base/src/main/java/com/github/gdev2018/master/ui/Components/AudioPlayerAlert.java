...
import com.github.gdev2018.master.ui.Cells.AudioPlayerCell;
            ...
            try {
                ...
                if (f.exists()) {
                    ...
                    if (Build.VERSION.SDK_INT >= 24) {
                        try {
                            intent.putExtra(Intent.EXTRA_STREAM, FileProvider.getUriForFile(BaseApplication.mApplicationContext, BuildConfig.APPLICATION_ID + ".provider", f));
