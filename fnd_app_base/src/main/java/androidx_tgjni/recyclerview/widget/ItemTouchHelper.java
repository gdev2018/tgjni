...
package androidx_tgjni.recyclerview.widget;
...
import androidx_tgjni.recyclerview.widget.RecyclerView.OnItemTouchListener;
import androidx_tgjni.recyclerview.widget.RecyclerView.ViewHolder;
 ...
 * {@link Callback#onMove(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder, ViewHolder)} and / or
 ...
 * customize these behaviors by overriding {@link Callback#onChildDraw(Canvas, androidx_tgjni.recyclerview.widget.RecyclerView,
 * ViewHolder, float, float, int, boolean)}
 * or {@link Callback#onChildDrawOver(Canvas, androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder, float, float, int,
 * boolean)}.
 * <p/>
 * Most of the time you only need to override <code>onChildDraw</code>.
 */
public class ItemTouchHelper extends androidx_tgjni.recyclerview.widget.RecyclerView.ItemDecoration
        implements androidx_tgjni.recyclerview.widget.RecyclerView.OnChildAttachStateChangeListener {
     ...
     * {@link Callback#getAbsoluteMovementFlags(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder)} for the current
     * action state.
     */
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    int mSelectedFlags;
    ...
    androidx_tgjni.recyclerview.widget.RecyclerView mRecyclerView;
     ...
     */
    private androidx_tgjni.recyclerview.widget.RecyclerView.ChildDrawingOrderCallback mChildDrawingOrderCallback = null;
    ...
    private final OnItemTouchListener mOnItemTouchListener = new OnItemTouchListener() {
        @Override
        public boolean onInterceptTouchEvent(@NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView,
        ...
        @Override
        public void onTouchEvent(@NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView, @NonNull MotionEvent event) {
            mGestureDetector.onTouchEvent(event);
            if (DEBUG) {
                Log.d(TAG,
     ...
     * {@link #attachToRecyclerView(androidx_tgjni.recyclerview.widget.RecyclerView)}. Upon attaching, it will add an item decoration,
     ...
     *                     RecyclerView.
     */
    public void attachToRecyclerView(@Nullable androidx_tgjni.recyclerview.widget.RecyclerView recyclerView) {
    ...
    @Override
    public void onDrawOver(Canvas c, androidx_tgjni.recyclerview.widget.RecyclerView parent, androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
        float dx = 0, dy = 0;
        if (mSelected != null) {
    ...
    @Override
    public void onDraw(Canvas c, androidx_tgjni.recyclerview.widget.RecyclerView parent, androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
        ...
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                if (mRecyclerView != null && mRecyclerView.isAttachedToWindow()
                        && !anim.mOverridden
                        && anim.mViewHolder.getAdapterPosition() != androidx_tgjni.recyclerview.widget.RecyclerView.NO_POSITION) {
                    final androidx_tgjni.recyclerview.widget.RecyclerView.ItemAnimator animator = mRecyclerView.getItemAnimator();
    ...
    boolean scrollIfNecessary() {
        ...
        androidx_tgjni.recyclerview.widget.RecyclerView.LayoutManager lm = mRecyclerView.getLayoutManager();
        if (mTmpRect == null) {
            mTmpRect = new Rect();
        }
        int scrollX = 0;
    ...
    private List<ViewHolder> findSwapTargets(ViewHolder viewHolder) {
        ...
        final androidx_tgjni.recyclerview.widget.RecyclerView.LayoutManager lm = mRecyclerView.getLayoutManager();
    ...
    @Override
    public void getItemOffsets(Rect outRect, View view, androidx_tgjni.recyclerview.widget.RecyclerView parent,
            androidx_tgjni.recyclerview.widget.RecyclerView.State state) {
        outRect.setEmpty();
    }
    ...
    void checkSelectForSwipe(int action, MotionEvent motionEvent, int pointerIndex) {
        ...
        if (mRecyclerView.getScrollState() == androidx_tgjni.recyclerview.widget.RecyclerView.SCROLL_STATE_DRAGGING) {
            return;
        }
    ...
    private void addChildDrawingOrderCallback() {
        ...
        if (mChildDrawingOrderCallback == null) {
            mChildDrawingOrderCallback = new androidx_tgjni.recyclerview.widget.RecyclerView.ChildDrawingOrderCallback() {
                @Override
     ...
     * {@link #getMovementFlags(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder)} and return appropriate set
     ...
     * {@link Callback#onMove(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder, ViewHolder)
     ...
     * in your adapter and also call {@link androidx_tgjni.recyclerview.widget.RecyclerView.Adapter#notifyItemMoved(int, int)}.
     * To control where a View can be dropped, you can override
     * {@link #canDropOver(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder, ViewHolder)}. When a
    ...
    public abstract static class Callback {
        ...
        /**
         * Returns the {@link androidx_tgjni.recyclerview.widget.ItemTouchUIUtil} that is used by the {@link Callback} class for
         * visual
         * changes on Views in response to user interactions. {@link androidx_tgjni.recyclerview.widget.ItemTouchUIUtil} has different
         ...
         * </pre>
         *
         * @return The {@link androidx_tgjni.recyclerview.widget.ItemTouchUIUtil} instance that is used by the {@link Callback}
         */
        @SuppressWarnings("WeakerAccess")
        @NonNull
        public static ItemTouchUIUtil getDefaultUIUtil() {
            return androidx_tgjni.recyclerview.widget.ItemTouchUIUtilImpl.INSTANCE;
        }
         ...
         */
        public abstract int getMovementFlags(@NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView,
        ...
        final int getAbsoluteMovementFlags(androidx_tgjni.recyclerview.widget.RecyclerView recyclerView,
                                           ViewHolder viewHolder) {
            final int flags = getMovementFlags(recyclerView, viewHolder);
            return convertToAbsoluteDirection(flags, ViewCompat.getLayoutDirection(recyclerView));
        }

        boolean hasDragFlag(androidx_tgjni.recyclerview.widget.RecyclerView recyclerView, ViewHolder viewHolder) {
            final int flags = getAbsoluteMovementFlags(recyclerView, viewHolder);
            return (flags & ACTION_MODE_DRAG_MASK) != 0;
        }

        boolean hasSwipeFlag(androidx_tgjni.recyclerview.widget.RecyclerView recyclerView,
                             ViewHolder viewHolder) {
            final int flags = getAbsoluteMovementFlags(recyclerView, viewHolder);
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public boolean canDropOver(@NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView, @NonNull ViewHolder current,
         ...
         * {@code target}.
         * @see #onMoved(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder, int, ViewHolder, int, int, int)
         */
        public abstract boolean onMove(@NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView,
         ...
         *                    {@link androidx_tgjni.recyclerview.widget.RecyclerView.ItemDecoration}s.
         ...
         * {@link #getMovementFlags(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder)} method, this method
         ...
         * {@link #clearView(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder)}.
         *
         * @param viewHolder The ViewHolder which has been swiped by the user.
         * @param direction  The direction to which the ViewHolder is swiped. It is one of
         *                   {@link #UP}, {@link #DOWN},
         *                   {@link #LEFT} or {@link #RIGHT}. If your
         *                   {@link #getMovementFlags(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder)}
         *                   method
         ...
         * @see #clearView(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder)
         */
        public void onSelectedChanged(@Nullable ViewHolder viewHolder, int actionState) {
            if (viewHolder != null) {
                androidx_tgjni.recyclerview.widget.ItemTouchUIUtilImpl.INSTANCE.onSelected(viewHolder.itemView);
            }
        }

        private int getMaxDragScroll(androidx_tgjni.recyclerview.widget.RecyclerView recyclerView) {
        ...
        /**
         * Called when {@link #onMove(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder, ViewHolder)} returns true.
         * <p>
         ...
         *
         * Default implementation calls {@link androidx_tgjni.recyclerview.widget.RecyclerView#scrollToPosition(int)} if the View's
         ...
         *                     {@link androidx_tgjni.recyclerview.widget.RecyclerView.ItemDecoration}s.
         */
        public void onMoved(@NonNull final androidx_tgjni.recyclerview.widget.RecyclerView recyclerView,
                @NonNull final ViewHolder viewHolder, int fromPos, @NonNull final ViewHolder target,
                int toPos, int x, int y) {
            final androidx_tgjni.recyclerview.widget.RecyclerView.LayoutManager layoutManager = recyclerView.getLayoutManager();
        ...
        void onDraw(Canvas c, androidx_tgjni.recyclerview.widget.RecyclerView parent, ViewHolder selected,
        ...
        void onDrawOver(Canvas c, androidx_tgjni.recyclerview.widget.RecyclerView parent, ViewHolder selected,
                        List<RecoverAnimation> recoverAnimationList,
                        int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
         ...
         * {@link #onChildDraw(Canvas, androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder, float, float, int,
         * boolean)} or
         * {@link #onChildDrawOver(Canvas, androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder, float, float, int, boolean)}.
         *
         * @param recyclerView The RecyclerView which is controlled by the ItemTouchHelper.
         * @param viewHolder   The View that was interacted by the user.
         */
        public void clearView(@NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView, @NonNull ViewHolder viewHolder) {
            androidx_tgjni.recyclerview.widget.ItemTouchUIUtilImpl.INSTANCE.clearView(viewHolder.itemView);
        }
         ...
         * @see #onChildDrawOver(Canvas, androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder, float, float, int,
         * boolean)
         */
        public void onChildDraw(@NonNull Canvas c, @NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView,
                @NonNull ViewHolder viewHolder,
                float dX, float dY, int actionState, boolean isCurrentlyActive) {
            androidx_tgjni.recyclerview.widget.ItemTouchUIUtilImpl.INSTANCE.onDraw(c, recyclerView, viewHolder.itemView, dX, dY,
                    actionState, isCurrentlyActive);
        }
         ...
         * boolean)
         */
        public void onChildDrawOver(@NonNull Canvas c, @NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView,
                ViewHolder viewHolder,
                float dX, float dY, int actionState, boolean isCurrentlyActive) {
            androidx_tgjni.recyclerview.widget.ItemTouchUIUtilImpl.INSTANCE.onDrawOver(c, recyclerView, viewHolder.itemView, dX, dY,
                    actionState, isCurrentlyActive);
        }
         ...
         * {@link androidx_tgjni.recyclerview.widget.RecyclerView.ItemAnimator#getMoveDuration()}, otherwise, it returns
         * {@link androidx_tgjni.recyclerview.widget.RecyclerView.ItemAnimator#getRemoveDuration()}. If RecyclerView does not have
         * any {@link androidx_tgjni.recyclerview.widget.RecyclerView.ItemAnimator} attached, this method returns
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public long getAnimationDuration(@NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView, int animationType,
                                         float animateDx, float animateDy) {
            final androidx_tgjni.recyclerview.widget.RecyclerView.ItemAnimator itemAnimator = recyclerView.getItemAnimator();
         ...
         * be passed to {@link androidx_tgjni.recyclerview.widget.RecyclerView#scrollBy(int, int)} method.
         */
        @SuppressWarnings("WeakerAccess")
        public int interpolateOutOfBoundsScroll(@NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView,
    ...
    public abstract static class SimpleCallback extends Callback {
         ...
         * {@link #getSwipeDirs(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder)}
         * and / or {@link #getDragDirs(androidx_tgjni.recyclerview.widget.RecyclerView, ViewHolder)}.
         *
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public int getSwipeDirs(@SuppressWarnings("unused") @NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView,
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public int getDragDirs(@SuppressWarnings("unused") @NonNull androidx_tgjni.recyclerview.widget.RecyclerView recyclerView,
