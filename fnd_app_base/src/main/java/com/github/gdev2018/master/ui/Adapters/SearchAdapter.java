        ...
        AndroidUtilities.runOnUIThread(() -> {
            ...
            Utilities.searchQueue.postRunnable(() -> {
                ...
                for (int a = 0; a < contactsCopy.size(); a++) {
                    ...
                    if (user.id == BaseUserConfig.getInstance(currentAccount).getClientUserId() || onlyMutual && !user.mutual_contact || ignoreUsers != null && ignoreUsers.indexOfKey(contact.user_id) >= 0) {
                        continue;
                    }
