...
public class VideoPlayer implements ExoPlayer.EventListener, SimpleExoPlayer.VideoListener, NotificationCenter.NotificationCenterDelegate {
    ...
    private void ensurePleyaerCreated() {
        ...
        if (player == null) {
            player = ExoPlayerFactory.newSimpleInstance(BaseApplication.mApplicationContext, trackSelector, loadControl, null, DefaultRenderersFactory.EXTENSION_RENDERER_MODE_PREFER);
