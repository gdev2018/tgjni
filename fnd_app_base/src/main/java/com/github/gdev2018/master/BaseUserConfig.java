...
//    public TLRPC.TL_help_appUpdate pendingAppUpdate;*/
    ...
    private static volatile BaseUserConfig[] Instance = new BaseUserConfig[BaseUserConfig.MAX_ACCOUNT_COUNT];
    public static BaseUserConfig getInstance(int num) {
        BaseUserConfig localInstance = Instance[num];
        if (localInstance == null) {
            synchronized (BaseUserConfig.class) {
                localInstance = Instance[num];
                if (localInstance == null) {
                    Instance[num] = localInstance = new BaseUserConfig(num);
                }
            }
        }
    ...
    public BaseUserConfig(int instance) {
