                    ...
                    AndroidUtilities.runOnUIThread(() -> {
                        ...
                        try {
                            ...
                            progressDialog[0].setButton(DialogInterface.BUTTON_NEGATIVE, LocaleController.getString("Cancel", R.string.Cancel), (dialog, which) -> {
                                ConnectionsManager.getInstance(BaseUserConfig.selectedAccount).cancelRequest(reqId, true);
                                try {
                                    dialog.dismiss();
                                } catch (Exception e) {
                                    FileLog.e(e);
        ...
        try {
            ...
            if (allowCustom && SharedConfig.customTabs && !internalUri && !scheme.equals("tel")) {
                ...
                if (forceBrowser[0] || allActivities == null || allActivities.isEmpty()) {
                    ...
                    builder.setActionButton(BitmapFactory.decodeResource(context.getResources(), R.drawable.abc_ic_menu_share_mtrl_alpha), LocaleController.getString("ShareFile", R.string.ShareFile), PendingIntent.getBroadcast(BaseApplication.mApplicationContext, 0, share, 0), false);
