...
public class LocaleController {
    ...
    private class TimeZoneChangedReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            BaseApplication.mApplicationHandler.post(() -> {
    ...
    public static class LocaleInfo {
        ...
        public File getPathToFile() {
            if (isRemote()) {
                return new File(BaseApplication.getFilesDirFixed(), "remote_" + shortName + ".xml");
            }
    ...
    public LocaleController() {
        ...
        is24HourFormat = DateFormat.is24HourFormat(BaseApplication.mApplicationContext);
...
///*            SharedPreferences preferences = MessagesController.getGlobalMainSettings();*/
        ...
        try {
            ...
            BaseApplication.mApplicationContext.registerReceiver(new TimeZoneChangedReceiver(), timezoneFilter);
        } catch (Exception e) {
            FileLog.e(e);
        }
    }
    ...
    public boolean applyLanguageFile(File file, int currentAccount) {
        try {
            ...
            if (languageName != null && languageName.length() > 0 &&
                ...
                File finalFile = new File(BaseApplication.getFilesDirFixed(), languageCode + ".xml");
    ...
    private void saveOtherLanguages() {
        SharedPreferences preferences = BaseApplication.mApplicationContext.getSharedPreferences("langconfig", Activity.MODE_PRIVATE);
    ...
    public void applyLanguage(final LocaleInfo localeInfo, boolean override, boolean init, boolean fromFile, boolean force, final int currentAccount) {
        ...
        try {
            ...
            BaseApplication.mApplicationContext.getResources().updateConfiguration(config, BaseApplication.mApplicationContext.getResources().getDisplayMetrics());
    ...
    private String getStringInternal(String key, int res) {
        ...
        if (value == null) {
            try {
                value = BaseApplication.mApplicationContext.getString(res);
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
    ...
    public static String getServerString(String key) {
        ...
        if (value == null) {
            int resourceId = BaseApplication.mApplicationContext.getResources().getIdentifier(key, "string", BaseApplication.mApplicationContext.getPackageName());
            if (resourceId != 0) {
                value = BaseApplication.mApplicationContext.getString(resourceId);
            }
        }
        return value;
    }
    ...
    public static String getPluralString(String key, int plural) {
        ...
        param = key + "_" + param;
        int resourceId = BaseApplication.mApplicationContext.getResources().getIdentifier(param, "string", BaseApplication.mApplicationContext.getPackageName());
    ...
    public static String formatLocationUpdateDate(long date) {
        try {
            ...
            if (dateDay == day && year == dateYear) {
                ...
                return formatString("LocationUpdatedFormatted", R.string.LocationUpdatedFormatted, formatString("TodayAtFormatted", R.string.TodayAtFormatted, getInstance().formatterDay.format(new Date(date))));
            } else if (dateDay + 1 == day && year == dateYear) {
                return formatString("LocationUpdatedFormatted", R.string.LocationUpdatedFormatted, formatString("YesterdayAtFormatted", R.string.YesterdayAtFormatted, getInstance().formatterDay.format(new Date(date))));
            } else if (Math.abs(System.currentTimeMillis() - date) < 31536000000L) {
    ...
    public static String formatDateOnline(long date) {
        try {
            ...
            if (dateDay == day && year == dateYear) {
                return formatString("LastSeenFormatted", R.string.LastSeenFormatted, formatString("TodayAtFormatted", R.string.TodayAtFormatted, getInstance().formatterDay.format(new Date(date))));
                ...
                return formatString("LastSeenFormatted", R.string.LastSeenFormatted, formatString("YesterdayAtFormatted", R.string.YesterdayAtFormatted, getInstance().formatterDay.format(new Date(date))));
            } else if (Math.abs(System.currentTimeMillis() - date) < 31536000000L) {
                String format = LocaleController.formatString("formatDateAtTime", R.string.formatDateAtTime, getInstance().formatterMonth.format(new Date(date)), getInstance().formatterDay.format(new Date(date)));
...
//            }*/
    ...
    public void saveRemoteLocaleStrings(final TLRPC.TL_langPackDifference difference, int currentAccount) {
        ...
        File finalFile = new File(BaseApplication.getFilesDirFixed(), "remote_" + langCode + ".xml");
        try {
