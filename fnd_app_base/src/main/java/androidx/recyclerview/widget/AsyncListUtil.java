...
public class AsyncListUtil<T> {
    ...
    public AsyncListUtil(@NonNull Class<T> klass, int tileSize,
        ...
        androidx.recyclerview.widget.ThreadUtil<T> threadUtil = new androidx.recyclerview.widget.MessageThreadUtil<T>();
    ...
    private final androidx.recyclerview.widget.ThreadUtil.MainThreadCallback<T>
            mMainThreadCallback = new androidx.recyclerview.widget.ThreadUtil.MainThreadCallback<T>() {
        @Override
    ...
    private final androidx.recyclerview.widget.ThreadUtil.BackgroundCallback<T>
            mBackgroundCallback = new androidx.recyclerview.widget.ThreadUtil.BackgroundCallback<T>() {
