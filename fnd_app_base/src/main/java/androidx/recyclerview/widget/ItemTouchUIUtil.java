 ...
 * {@link androidx.recyclerview.widget.RecyclerView.ViewHolder#itemView} and {@link ItemTouchUIUtil} makes necessary changes
...
public interface ItemTouchUIUtil {
     ...
     * androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.ViewHolder, float, float, int, boolean)}
     */
    void onDraw(Canvas c, androidx.recyclerview.widget.RecyclerView recyclerView, View view,
     ...
     * androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView.ViewHolder, float, float, int, boolean)}
     */
    void onDrawOver(Canvas c, androidx.recyclerview.widget.RecyclerView recyclerView, View view,
                    float dX, float dY, int actionState, boolean isCurrentlyActive);

    /**
     * The default implementation for {@link ItemTouchHelper.Callback#clearView(androidx.recyclerview.widget.RecyclerView,
