...
import com.github.gdev2018.master.ui.Cells.TextInfoCell;
...
///*import com.github.gdev2018.master.ui.Components.ImageUpdater;*/
...
//import com.github.gdev2018.master.di.BaseApplication.getGlobalMainSettings;
        ...
        listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() {
            ...
            public boolean onItemClick(View view, int position) {
                if (position == versionRow) {
                    pressCount++;
                    if (pressCount >= 2 || BaseBuildVars.DEBUG_PRIVATE_VERSION) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                        ...
                        items = new CharSequence[]{
                                ...
                                BaseBuildVars.LOGS_ENABLED ? LocaleController.getString("DebugMenuDisableLogs", R.string.DebugMenuDisableLogs) : LocaleController.getString("DebugMenuEnableLogs", R.string.DebugMenuEnableLogs),
                                ...
                                null,
                                BaseBuildVars.DEBUG_PRIVATE_VERSION ? "Check for app updates" : null
                        };
...
///*                                MessagesController.getInstance(currentAccount).forceResetDialogs();*/
                                ...
                                BaseBuildVars.LOGS_ENABLED = !BaseBuildVars.LOGS_ENABLED;
                                ...
                                sharedPreferences.edit().putBoolean("logsEnabled", BaseBuildVars.LOGS_ENABLED).commit();
                            } else if (which == 5) {
