...
import androidx_tgjni.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo;
...
public class RecyclerView extends ViewGroup implements ScrollingView,
    ...
    androidx_tgjni.recyclerview.widget.GapWorker mGapWorker;
    androidx_tgjni.recyclerview.widget.GapWorker.LayoutPrefetchRegistryImpl mPrefetchRegistry =
            ALLOW_THREAD_GAP_WORK ? new androidx_tgjni.recyclerview.widget.GapWorker.LayoutPrefetchRegistryImpl() : null;
    ...
    androidx_tgjni.recyclerview.widget.RecyclerViewAccessibilityDelegate mAccessibilityDelegate;
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        setAccessibilityDelegateCompat(new androidx_tgjni.recyclerview.widget.RecyclerViewAccessibilityDelegate(this));
     ...
     */
    @Nullable
    public androidx_tgjni.recyclerview.widget.RecyclerViewAccessibilityDelegate getCompatAccessibilityDelegate() {
    ...
    public void setAccessibilityDelegateCompat(
            @Nullable androidx_tgjni.recyclerview.widget.RecyclerViewAccessibilityDelegate accessibilityDelegate) {
    ...
    protected void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ...
            mGapWorker = androidx_tgjni.recyclerview.widget.GapWorker.sGapWorker.get();
            if (mGapWorker == null) {
                mGapWorker = new androidx_tgjni.recyclerview.widget.GapWorker();
                ...
                androidx_tgjni.recyclerview.widget.GapWorker.sGapWorker.set(mGapWorker);
            }
            mGapWorker.add(this);
        }
    }
    ...
    public static class RecycledViewPool {
         ...
         * constructed by {@link androidx_tgjni.recyclerview.widget.GapWorker} prefetch from being bound to a lower priority prefetch.
         */
    ...
    public abstract static class LayoutManager {
         ...
         */
        private final androidx_tgjni.recyclerview.widget.ViewBoundsCheck.Callback mHorizontalBoundCheckCallback =
                new androidx_tgjni.recyclerview.widget.ViewBoundsCheck.Callback() {
                    @Override
         ...
         * vertical direction.
         */
        private final androidx_tgjni.recyclerview.widget.ViewBoundsCheck.Callback mVerticalBoundCheckCallback =
                new androidx_tgjni.recyclerview.widget.ViewBoundsCheck.Callback() {
                    @Override
                    public View getChildAt(int index) {
                        return LayoutManager.this.getChildAt(index);
         ...
         * {@link androidx_tgjni.recyclerview.widget.LinearLayoutManager#findOneVisibleChild(int, int, boolean, boolean)},
         * and {@link LinearLayoutManager#findOnePartiallyOrCompletelyInvisibleChild(int, int)}.
         */
        androidx_tgjni.recyclerview.widget.ViewBoundsCheck mHorizontalBoundCheck = new androidx_tgjni.recyclerview.widget.ViewBoundsCheck(mHorizontalBoundCheckCallback);
        androidx_tgjni.recyclerview.widget.ViewBoundsCheck mVerticalBoundCheck = new androidx_tgjni.recyclerview.widget.ViewBoundsCheck(mVerticalBoundCheckCallback);
        ...
        /**
         * Written by {@link androidx_tgjni.recyclerview.widget.GapWorker} when prefetches occur to track largest number of view ever
        ...
        public boolean isViewPartiallyVisible(@NonNull View child, boolean completelyVisible,
            ...
            int boundsFlag = (androidx_tgjni.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_GT_PVS | androidx_tgjni.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_EQ_PVS
                    | androidx_tgjni.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_LT_PVE | androidx_tgjni.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_EQ_PVE);
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable,
        ...
        new androidx_tgjni.recyclerview.widget.FastScroller(this, verticalThumbDrawable, verticalTrackDrawable,
     ...
     *
     * @see androidx_tgjni.recyclerview.widget.LinearSmoothScroller
     */
    public abstract static class SmoothScroller {
        ...
        public interface ScrollVectorProvider {
             ...
             * can be found.
             * <p>
             * This method is used by the {@link androidx_tgjni.recyclerview.widget.LinearSmoothScroller} to initiate a scroll towards
             * the target position.
             * <p>
