...
public abstract class SnapHelper extends RecyclerView.OnFlingListener {
     ...
     *                          {@link RecyclerView}.
     *
     * @return a {@link androidx_tgjni.recyclerview.widget.LinearSmoothScroller} which will handle the scrolling.
     * @deprecated use {@link #createScroller(RecyclerView.LayoutManager)} instead.
     */
    @Nullable
    @Deprecated
    protected androidx_tgjni.recyclerview.widget.LinearSmoothScroller createSnapScroller(RecyclerView.LayoutManager layoutManager) {
        if (!(layoutManager instanceof RecyclerView.SmoothScroller.ScrollVectorProvider)) {
            return null;
        }
