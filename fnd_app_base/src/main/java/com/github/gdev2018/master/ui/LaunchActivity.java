...
import com.github.gdev2018.master.ui.ActionBar.DrawerLayoutContainer;
import com.github.gdev2018.master.ui.ActionBar.Theme;
import com.github.gdev2018.master.ui.Adapters.DrawerLayoutAdapter;
import com.github.gdev2018.master.ui.Cells.DrawerAddCell;
import com.github.gdev2018.master.ui.Cells.DrawerUserCell;
import com.github.gdev2018.master.ui.Cells.LanguageCell;
import com.github.gdev2018.master.ui.Components.AlertsCreator;
///*import com.github.gdev2018.master.ui.Components.AudioPlayerAlert;*/
import com.github.gdev2018.master.ui.Components.BlockingUpdateView;
///*import com.github.gdev2018.master.ui.Components.EmbedBottomSheet;*/
import com.github.gdev2018.master.ui.Components.LayoutHelper;
import com.github.gdev2018.master.ui.Components.PasscodeView;
...
///*import com.github.gdev2018.master.ui.Components.SharingLocationsAlert;*/
///*import com.github.gdev2018.master.ui.Components.StickersAlert;*/
import com.github.gdev2018.master.ui.Components.TermsOfServiceView;
import com.github.gdev2018.master.ui.Components.ThemeEditorView;
import com.github.gdev2018.master.ui.Components.UpdateAppAlertDialog;
...
///*            SharedPreferences preferences = MessagesController.getGlobalMainSettings();*/
            ...
            if (!isProxy && Math.abs(crashed_time - System.currentTimeMillis()) >= 60 * 2 * 1000 && intent != null && !fromIntro) {
                preferences = BaseApplication.mApplicationContext.getSharedPreferences("logininfo2", MODE_PRIVATE);
...
///*                    SharedPreferences preferences = MessagesController.getGlobalMainSettings();*/
                    SharedPreferences preferences = BaseApplication.getGlobalMainSettings();
                    if (!BaseBuildVars.DEBUG_VERSION && preferences.getBoolean("channel_intro", false)) {
                        Bundle args = new Bundle();
                        args.putInt("step", 0);
...
///*                                runLinkRequest(intentAccount[0], username, group, sticker, botUser, botChat, message, hasUrl, messageId, game, instantView, auth, unsupportedUrl, 0);*/
                    ...
                    } else if (intent.getAction().equals("com.github.gdev2018.master.OPEN_ACCOUNT")) {
                        open_settings = 1;
...
//                    }));*/
                ...
                pushOpened = false;
            } else if (videoPath != null || sendingText != null || documentsPathsArray != null || contactsToSend != null || documentsUrisArray != null) {
                if (!AndroidUtilities.isTablet()) {
                    NotificationCenter.getInstance(intentAccount[0]).postNotificationName(NotificationCenter.closeChats);
                }
                if (dialogId == 0) {
...
//    }
    ...
    public void checkAppUpdate(boolean force) {
        if (!force && BaseBuildVars.DEBUG_VERSION || !force && !BaseBuildVars.CHECK_UPDATES) {
            return;
        }
            ...
            if (response instanceof TLRPC.TL_help_appUpdate) {
                ...
                AndroidUtilities.runOnUIThread(() -> {
                    ...
                    if (!res.popup) {
                        ...
                        UserConfig.getInstance(0).pendingAppUpdateBuildVersion = BaseBuildVars.BUILD_VERSION;
                        try {
...
///*                        CameraController.getInstance().initCamera(null);*/
    ...
    protected void onPause() {
        ...
        BaseApplication.mainInterfacePaused = true;
        Utilities.stageQueue.postRunnable(() -> {
            BaseApplication.mainInterfacePausedStageQueue = true;
            BaseApplication.mainInterfacePausedStageQueueTime = 0;
        });
        onPasscodePause();
...
///*        MediaController.getInstance().setFeedbackView(actionBarLayout, true);*/
        ...
        BaseApplication.mainInterfacePaused = false;
///*        NotificationsController.lastNoDataNotificationTime = 0;*/
        Utilities.stageQueue.postRunnable(() -> {
            BaseApplication.mainInterfacePausedStageQueue = false;
            BaseApplication.mainInterfacePausedStageQueueTime = System.currentTimeMillis();
        });
        checkFreeDiscSpace();
