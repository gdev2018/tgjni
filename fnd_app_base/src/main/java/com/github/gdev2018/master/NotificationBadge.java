...
public class NotificationBadge {
        ...
        public void executeBadge(int badgeCount) {
            ...
            if (canResolveBroadcast(intent)) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public void run() {
                        BaseApplication.mApplicationContext.sendBroadcast(intent);
                    }
                });
            }
        }
    ...
    public static class HuaweiHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            localBundle.putString("package", BaseApplication.mApplicationContext.getPackageName());
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    try {
                        BaseApplication.mApplicationContext.getContentResolver().call(Uri.parse("content://com.huawei.android.launcher.settings/badge/"), "change_badge", null, localBundle);
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
                }
        ...
        public void executeBadge(int badgeCount) {
            ...
            if (canResolveBroadcast(intent1) || canResolveBroadcast(intent)) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public void run() {
                        BaseApplication.mApplicationContext.sendBroadcast(intent1);
                        BaseApplication.mApplicationContext.sendBroadcast(intent);
                    }
                });
            }
    ...
    public static class NovaHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            BaseApplication.mApplicationContext.getContentResolver().insert(Uri.parse(CONTENT_URI), contentValues);
        }
    ...
    public static class OPPOHomeBader implements Badger {
        ...
        private void executeBadgeByContentProvider(int badgeCount) {
            try {
                ...
                BaseApplication.mApplicationContext.getContentResolver().call(Uri.parse(PROVIDER_CONTENT_URI), "setAppBadgeCount", null, extras);
    ...
    public static class SonyHomeBadger implements Badger {
        ...
        private void executeBadgeByContentProvider(int badgeCount) {
            ...
            if (mQueryHandler == null) {
                mQueryHandler = new AsyncQueryHandler(BaseApplication.mApplicationContext.getApplicationContext().getContentResolver()) {
        ...
        private static boolean sonyBadgeContentProviderExists() {
            ...
            ProviderInfo info = BaseApplication.mApplicationContext.getPackageManager().resolveContentProvider(SONY_HOME_PROVIDER_NAME, 0);
            if (info != null) {
                exists = true;
            }
            return exists;
            ...
            try {
                ...
                if (canResolveBroadcast(localIntent)) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        @Override
                        public void run() {
                            BaseApplication.mApplicationContext.sendBroadcast(localIntent);
                        }
                    });
                }
            }
    ...
    public static class ZukHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    try {
                        BaseApplication.mApplicationContext.getContentResolver().call(CONTENT_URI, "setAppBadgeCount", null, extra);
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
                }
    ...
    public static class VivoHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            intent.putExtra("packageName", BaseApplication.mApplicationContext.getPackageName());
            intent.putExtra("className", componentName.getClassName());
    ...
    private static boolean initBadger() {
        Context context = BaseApplication.mApplicationContext;
